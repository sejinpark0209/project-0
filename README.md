...
* Be **deployed publicly online**, where the rest of the world can access it (using a [github pages project page](https://help.github.com/articles/user-organization-and-project-pages/#project-pages) or [bitballoon](https://www.bitballoon.com/))
...
* **Reference notes** from class & ask questions to the instructional team when you need to!
